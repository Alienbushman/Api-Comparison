...
//    private static domain = "http://localhost:8080"
    ...
    private static final String getFormat = domain + "/textReader"
    ...
    static String getAuth(String auth) {
        ...
        AuthPogo responsePogo = objectMapper.readValue(response.body().string(), AuthPogo.class)
        response.close()
    ...
    static String simplePost() {
        String url = domain + "/textReader"
        ...
        return responsePogo.toString()
    }

    static String simpleSecretPost() {
